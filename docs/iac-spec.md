...
## 6. GitHub Actions CI (セキュリティスキャン・静的解析)
...
| CI - IaC (Terraform static analysis) | `.github/workflows/ci-iac.yaml` | `iac/**` |
...
### 6.2 IaC 静的解析 CI (`ci-iac.yaml`)

`iac/` 配下の変更を含む PR に対して以下を自動実行する。
